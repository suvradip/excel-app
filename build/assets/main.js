...
(function () {
    ...
    proto.addRow = function () {
        ...
        if (isAppend) this.table.append(tr);else this.table.prepend(tr, row);
        ...
        //console.log(this.table.bBox());
        if (this.rowCounts > 1) this.rowlHandler(id, tr.bBox().width, tr.bBox().offsetTop, tr.bBox().offsetLeft);
        return tr;
    };
